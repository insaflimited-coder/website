...
export default function Home() {
  const [activePanel, setActivePanel] = useState(1) // screenshot এর মত 2nd টা active
  ...
  return (
    ...
    >
      ...
      {/* ========== HEADER AFTER COMPACT SLIDER ========== */}
      <section
        className="header-after-slider"
        style={{
          padding: '95px 5% 40px',
          background: '#0A0A0A',
          position: 'relative',
      ...
      >
        <div style={{ maxWidth: '1400px', marginTop: '0', marginBottom: '0', marginLeft: 'auto', marginRight: 'auto' }}>

          {/* DESKTOP - ACCORDION */}
          <div className="compact-panels" style={{ display: 'flex', gap: '16px', height: '520px' }}>
            {compactSlides.map((slide, idx) => {
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: isActive ? '0 25px 60px rgba(0,0,0,0.5)' : '0 15px 30px rgba(0,0,0,0.3)',
                    transform: isActive ? 'translateY(-5px)' : 'none',
                    border: '1px solid rgba(255,255,255,0.06)',
                    overflow: 'hidden'
                  }}
                >
                  {/* Image Container - 85% of space */}
                  <div
                    style={{
                      flex: 5.6,
                  ...
                  {/* Text Container - Slim footer */}
                  <div
                    style={{
                      flex: 1,
                      backgroundColor: '#0F0F0F',
                      padding: isActive ? '10px 16px' : '8px 12px',
          ...
          {/* MOBILE - CAROUSEL */}
          <div className="mobile-compact" style={{ display: 'none' }}>
            <div
              style={{ position: 'relative', overflow: 'hidden', borderRadius: '24px', height: '480px' }}
              onTouchStart={(e) => touchStart.current = e.touches[0].clientX}
              onTouchEnd={(e) => {
                const diff = e.changedTouches[0].clientX - touchStart.current
                if (diff > 50) setActivePanel(p => (p + 3) % 4)
                if (diff < -50) setActivePanel(p => (p + 1) % 4)
              }}
            >
              <div style={{ display: 'flex', height: '100%', transform: `translateX(-${activePanel * 100}%)`, transition: 'transform 0.5s ease' }}>
                {compactSlides.map((slide, idx) => (
                  <div
                    key={idx}
                    style={{
                  ...
                  >
                    ...
                    {/* Text Container - Slim footer bar */}
                    <div
                      style={{
                        flex: 1,
                        backgroundColor: '#0F0F0F',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '8px', marginTop: '22px' }}>
            {compactSlides.map((_, idx) => (
              <button key={idx} onClick={() => setActivePanel(idx)} style={{ width: activePanel === idx ? '22px' : '9px', height: '9px', borderRadius: '10px', background: activePanel === idx ? '#FFD700' : 'transparent', border: '1.5px solid #FFD700', transition: 'all 0.3s', cursor: 'pointer' }} />
            ))}
          </div>
        </div>
      </section>
          ...
          >
            ...
            >
              ...
              <span style={{ color: '#FFD700', fontSize: '12px', letterSpacing: '2px', fontWeight: '600' }}>
                Trusted by Homeowners | Supporting RAJUK Plan Approval Process
              </span>
            </div>
        ...
        <div style={{ maxWidth: '1400px', marginTop: '0', marginBottom: '0', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          >
            ...
            >
              ...
              <h3 style={{ fontSize: '22px', fontWeight: '800', color: 'white', marginBottom: '12px' }}>Architectural Design</h3>
            ...
            >
              ...
              <h3 style={{ fontSize: '22px', fontWeight: '800', color: 'white', marginBottom: '12px' }}>Structural Design</h3>
              <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)', lineHeight: '1.7' }}>
          ...
          >
            {[
              ...
              >
                <div style={{ fontSize: '40px', marginBottom: '12px', animation: `iconFloat 3s ease-in-out infinite ${idx * 0.2}s` }}>
                  {service.icon}
                </div>
          ...
          >
            {[
              ...
              >
                <div style={{ fontSize: '40px', marginBottom: '12px', animation: `iconFloat 3s ease-in-out infinite ${0.4 + idx * 0.2}s` }}>
                  {service.icon}
                </div>
                <h4 style={{ fontSize: '16px', fontWeight: '700', color: 'white', marginBottom: '8px' }}>{service.title}</h4>
                <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', lineHeight: '1.5' }}>{service.desc}</p>
          ...
          >
            {[
              ...
              >
                ...
                <div style={{ fontSize: '50px', animation: 'iconFloat 4s ease-in-out infinite', flexShrink: 0, marginLeft: '20px' }}>
                  {service.icon}
                </div>
              </div>
            ))}
          ...
          >
            {[
              ...
              >
                <div style={{ fontSize: '40px', animation: `wiggle 2s ease-in-out infinite ${idx * 0.3}s`, flexShrink: 0 }}>
                  {service.icon}
                </div>
                <div>
      ...
      >
        <div style={{ maxWidth: '1200px', marginTop: '0', marginBottom: '0', marginLeft: 'auto', marginRight: 'auto' }}>
              ...
              >
                ...
                <div style={{ marginBottom: '20px' }}>
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <span key={i} style={{ color: '#FFD700', fontSize: '18px', animation: `starTwinkle 1.5s ease-in-out infinite ${i * 0.15}s` }}>
                      ★
                    </span>
                  ))}
                </div>
                ...
                <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '20px' }}>
                  <div style={{ fontSize: '16px', fontWeight: '700', color: 'white', animation: 'textGlow 3s ease-in-out infinite' }}>
                    {testimonial.name}
                  </div>
      ...
      >
        <div style={{ maxWidth: '1000px', marginTop: '0', marginBottom: '0', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            {[
              {
                step: '01',
                title: 'Consultation',
                desc: 'Understanding your vision and project requirements to plan the best approach.',
                time: 'Week 1',
                color: '#667eea'
              },
              {
                ...
                desc: 'Site analysis, DAP check, and budget planning to ensure a practical and compliant design.',
                time: 'Week 2-3',
                color: '#f093fb'
              },
              {
                ...
                desc: '3D visualization, architectural planning, and structural concept development for your project.',
                time: 'Week 4-8',
                color: '#4facfe'
              },
              {
                step: '04',
                title: 'RAJUK Submission',
                desc: 'Complete documentation, coordination, and approval process with RAJUK for hassle-free compliance.',
                time: 'Month 3-6',
                color: '#43e97b'
              },
              {
                ...
                desc: 'Professional site supervision, quality assurance, and technical support throughout construction.',
                time: 'Ongoing',
                color: '#fa709a'
              }
            ].map((process, idx) => (
      ...
      >
        ...
        <div style={{ width: '100%', textAlign: 'center', position: 'relative', zIndex: 2, paddingTop: '0', paddingBottom: '0', paddingLeft: '5%', paddingRight: '5%' }}>
          <div style={{ maxWidth: '900px', marginTop: '0', marginBottom: '0', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            >
              Join 1000+ satisfied clients who have trusted Insaf Building Design & Consultant Ltd. to turn their architectural dreams into reality. We combine modern architectural aesthetics with strong structural engineering to create spaces that inspire and stand the test of time.
            </p>
            ...
            <div style={{ marginTop: '50px', color: 'rgba(255,255,255,0.4)', fontSize: '14px', animation: 'fadeIn 1.6s ease-out 0.8s backwards' }}>
              ...
              <span style={{ marginTop: '0', marginBottom: '0', marginLeft: '20px', marginRight: '20px' }}>•</span>
      ...
      <style jsx>{`
        * {
        ...
        /* ===== COMPACT HEADER SLIDER ===== */
        .wpaas-row-clearfix:before,
        .wpaas-row-clearfix:after {
          content: "";
          display: table;
        }
        ...
        .wpos-tab-slider .as-layer.as-rounded {
          border-radius: 10px;
        }
        ...
        @keyframes buttonGlow {
          ...
          50% {
            box-shadow: 0 35px 70px rgba(255, 215, 0, 0.6);
          }
        }
        ...
        @media (max-width: 568px) {
          ...
          .compact-panel.active .compact-content {
            left: 8px !important;
            right: 8px !important;
          ...
          .compact-panel.active .compact-content h3 {
            font-size: 14px !important;
          }

          .compact-panel:not(.active) .compact-content h3 {
            font-size: 10px !important;
          }
        }
